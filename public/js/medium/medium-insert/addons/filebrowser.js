;(function ($, window, document, undefined) {
    ...
    var pluginName = 'mediumInsert',
        ...
        defaults = {
            ...
            captions: true,
            captionPlaceholder: mediumInsertOptions().addons.embeds.captionPlaceholder,
        };
    ...
    Filebrowser.prototype.addToolbar = function () {
        ...
        var top = $image.offset().top - $toolbar2.height() - 8 - 2 - 5; // 8px - hight of an arrow under toolbar, 2px - height of an image outset, 5px - distance from an image
        if (top < 0) {
            top = 0;
        }
