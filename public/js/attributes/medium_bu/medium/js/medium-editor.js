...
(function () {
    ...
    var AnchorForm = MediumEditor.extensions.form.extend({
         ...
         */
        customClassOption: window.anchorClass,

        /* customClassOptionText: [string]
         * text to be shown in the checkbox when the __customClassOption__ is being used.
         */
        customClassOptionText: window.anchorClassTitle || 'Button',
        ...
        getTemplate: function () {
            ...
            if (this.customClassOption) {
                ...
                template.push(
                    '<div class="medium-editor-toolbar-form-row">',
                    '<input type="checkbox" class="medium-editor-toolbar-anchor-button" id="medium-editor-toolbar-anchor-button">',
                    '<label for="medium-editor-toolbar-anchor-button">',
