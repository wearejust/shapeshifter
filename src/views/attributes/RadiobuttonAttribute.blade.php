		...
		<div class="form-field radio">
			<div class="form-options">
				<ul class="list form-options-content">
			        ...
			        <li class="form-option form-option-grid-2 form-option-grid-3"> <!-- form-option-grid-2 gebruiken voor 2 items naast elkaar, form-option-grid-3 voor 3 (op groot scherm) -->
